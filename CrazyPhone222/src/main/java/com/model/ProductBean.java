...
public class ProductBean {
	...
	public ProductBean(Integer productID, String productName, Blob productImage, String productIntro, Integer unitPrice,
			...
			MultipartFile pImage2, MultipartFile pImage3, Set<CriticismBean> criticisms, TypeBean typeBean,
			BrandBean brandBean, SpecBean specBean) {
		super();
		ProductID = productID;
	...
	public String toString() {
		return "ProductBean [ProductID=" + ProductID + ", ProductName=" + ProductName + ", ProductImage=" + ProductImage
				...
				+ ", ProductFileName3=" + ProductFileName3 + ", PImage=" + PImage + ", PImage2=" + PImage2
				+ ", PImage3=" + PImage3 + ", criticisms=" + criticisms + ", typeBean=" + typeBean + ", brandBean="
				+ brandBean + ", specBean=" + specBean + "]";
	}
