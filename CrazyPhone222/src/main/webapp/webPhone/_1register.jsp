...
<body>
	...
	<div id="id01" class="modal">
		...
		<h1 style="text-align: center; margin-bottom: -50px; color: white;">
			註冊會員</h1>
		<form:form class="modal-content animate" method="post"
			...
			<div class="container">
				...
				<label for="MemberEmail"><b>帳號</b></label> &nbsp;<small><Font
					color='red' size="-3">${ErrorKey.AccountEmptyError} </Font></small> &nbsp;<small><Font
					color='red' size="-3">${ErrorKey.mailError} </Font></small>
				<form:input type="text" path="MemberEmail" id="MemberEmail" />


				<label for="MemberPwd"><b>密碼</b></label> &nbsp;<small><Font
					color='red' size="-3">${ErrorKey.PswAccountEmptyError} </Font></small>
				<form:input type="password" path="MemberPwd" id="MemberPwd" />

				<label for="checkPwd"><b>確認密碼</b></label> &nbsp;<small><Font
					color='red' size="-3"> </Font></small> <input type="password"
					nema="checkPwd" id="checkPwd1" /> <label for="MemberName"><b>姓名</b></label>
				&nbsp;<small><Font color='red' size="-3">${ErrorKey.NameEmptyError}
				</Font></small>
				<form:input type="text" path="MemberName" id="MemberName" />


				<label for="MemberBirth"><b>生日</b></label> &nbsp;<small><Font
					color='red' size="-3">${ErrorKey.BirthEmptyError} </Font></small>
				<form:input type="date" path="MemberBirth" id="MemberBirth" />


				<label for="MemberPhone"><b>連絡電話</b></label> &nbsp;<small><Font
					color='red' size="-3">${ErrorKey.PhoneEmptyError} </Font></small>
				<form:input type="text" path="MemberPhone" id="MemberPhone" />

				<label for="MemberAddress"><b>地址</b></label> &nbsp;<small><Font
					color='red' size="-3">${ErrorKey.AddressEmptyError} </Font></small>
				<form:input type="text" path="MemberAddress" id="MemberAddress" />


				<label for="MImage"><b>照片</b></label>
				<form:input type="file" path="MImage" id="MImage" />
				<br> <img id="changeimg" src="" />
