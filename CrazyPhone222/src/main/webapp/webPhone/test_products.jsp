				...
				<section class="sky-form">
				 ...
				 -->
					...
					<!--  
						...
						<input id="priceS" type="text" name="lowestPrice" placeholder="最低價"
								value="" size="5" maxlength="5" pattern="[0-9]{0,5}" title="價格區間請輸入非零數字">
								&nbsp;~&nbsp;
						 <input id="priceE"	type="text" name="highestPrice" placeholder="最高價" 
						         value=""size="5" maxlength="5" pattern="[0-9]{0,5}" title="價格區間請輸入非零數字">
