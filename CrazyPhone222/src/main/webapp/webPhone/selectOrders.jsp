			...
			<div class="ddd">
				...
				<table border='2' cellpadding="3" cellspacing="1">
					...
					<c:forEach var='orderSelectMember1' items='${orderSelectMember}'>
	                    <c:choose>
	                    <c:when	test="${orderSelectMember1.orderID== number1}"  >
	                    </c:when>
	                   <c:otherwise>
						<tr>
							...
							<td style="text-align: center"><a data-toggle="collapse"
								...
								href="#collapse${orderSelectMember1.ID}"> 查看 </a></td>
												</c:otherwise>
						</c:choose>
							<div id="collapse${orderSelectMember1.ID}"
								class="panel-collapse collapse">
								<div class="panel-body"
									style="margin-left: 60%; border: 1.5px solid transparent; border-radius: 10px; background-color: #d3ddeb; position: relative; font-weight: bold;">
									...
									<c:forEach var='orderSelectMember2' items='${orderSelectMember}'>
										...
										<c:choose>
											<c:when	test="${number1 == number2}"  >
													...
													商品名稱:${orderSelectMember2.productName}<br>
