				...
				<div class="col-md-9 header-left">
					<div class="top-nav">
						<ul class="memenu skyblue">
							...
							<li class="grid"><a href="products">商城</a> <!-- 								<div class="mepanel"> -->
								<!-- 									<div class="row"> --> <!-- 										<div class="col1 me-one"> -->
								<!-- 											<h4>Shop</h4> --> <!-- 											<ul> --> <!-- 												<li><a href="products.html">New Arrivals</a></li> -->
								...
								<!-- 												<li><a href="products.html">Tin</a></li> --> <!-- 											</ul> -->
								<!-- 										</div> --> <!-- 									</div> --> <!-- 								</div> -->
							</li>
							...
							<c:if test="${! empty LoginSuperOK }">
								<span style="margin: 50px">Hello <a href="up1">${LoginSuperOK.supervisorName}</a>(管理人員)
								</span>
			...
			<div class="contact-text">
				...
				<div class="container2" style="position: relative; top: -50px">
					...
					<form:form method='POST' modelAttribute="CriticismBean"
						...
						<c:if test="${! empty LoginOK }">
							<img width='60' height='60' style="margin: 5px"
								src="<c:url value='/getmemImg/${LoginOK.memberID}'/>" />
...
<!-- 						<label for="CriticismImage">目前照片</label> -->
<!-- 						<img width='200' height='160' -->
<%-- 							src="<c:url value='/getPicture2/${criticism.criticismID}' />" /> --%>
<!-- 						<img width='100' height='80' -->
<%-- 							src="<c:url value='/getPicture2/${criticism.criticismID}' />" /> --%>
						<br>
						<%-- 						value="${criticism.criticismImage}" --%>
						<form:input id="addCriticismImage" path="CriImage"
						...
						<div style="margin-top: 5px">
							...
							<button id="btnAdd" type="submit"
								class="btn btn-outline-secondary">送出</button>
							<button id="btnAdd" type="reset"
								class="btn btn-outline-secondary" style="align: right">清除</button>
						</div>
